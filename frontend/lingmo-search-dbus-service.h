...
class LingmoSearchDbusServices: public QObject, public QDBusContext
{
    Q_OBJECT
    Q_CLASSINFO("D-Bus Interface","org.lingmo.search.service")

public:
    explicit LingmoSearchDbusServices(MainWindow *m, QObject *parent = nullptr);
...
private:
    ...
    QString m_display;
    OrgLingmoSearchServiceInterface *m_serviceIface = nullptr;

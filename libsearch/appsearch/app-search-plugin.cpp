...
AppSearchPlugin::AppSearchPlugin(QObject *parent) : QThread(parent), m_appSearchTask(new LingmoSearchTask(this))
{
...
//AppSearch::AppSearch(DataQueue<SearchPluginIface::ResultInfo> *searchResult, DataQueue<ResultItem>* appSearchResults, LingmoSearchTask *appSearchTask, QString keyword, size_t uniqueSymbol)
//{

...
const QString LingmoSearch::WebSearchPlugin::name()
{
    return "Web Page";
}

const QString LingmoSearch::WebSearchPlugin::description()
{
    return tr("Web Page");
}

QString LingmoSearch::WebSearchPlugin::getPluginName()
{
    return tr("Web Page");
}

void LingmoSearch::WebSearchPlugin::KeywordSearch(QString keyword, DataQueue<LingmoSearch::SearchPluginIface::ResultInfo> *searchResult)
{
    m_keyWord = keyword;
...
QList<LingmoSearch::SearchPluginIface::Actioninfo> LingmoSearch::WebSearchPlugin::getActioninfo(int type)
{
    Q_UNUSED(type)
    return m_actionInfo;
}

void LingmoSearch::WebSearchPlugin::openAction(int actionkey, QString key, int type)
{
...
QWidget *LingmoSearch::WebSearchPlugin::detailPage(const LingmoSearch::SearchPluginIface::ResultInfo &ri)
{
    Q_UNUSED(ri)
    return m_detailPage;
}

void LingmoSearch::WebSearchPlugin::initDetailPage()
{

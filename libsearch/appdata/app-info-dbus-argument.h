...
QDBusArgument &operator << (QDBusArgument &argument, const LingmoSearch::ApplicationProperty::Property &property) {
...
const QDBusArgument &operator >> (const QDBusArgument &argument, LingmoSearch::ApplicationProperty::Property &property) {
    int value;
    argument.beginStructure();
    argument >> value;
    argument.endStructure();

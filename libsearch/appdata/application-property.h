...
Q_DECLARE_METATYPE(LingmoSearch::ApplicationProperty::Property)
Q_DECLARE_METATYPE(LingmoSearch::ApplicationPropertyMap)
Q_DECLARE_METATYPE(LingmoSearch::ApplicationInfoMap)
Q_DECLARE_METATYPE(LingmoSearch::ApplicationProperties)

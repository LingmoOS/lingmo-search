...
{
    //dbus接收数据库信号
    qRegisterMetaType<LingmoSearch::ApplicationProperty::Property>("ApplicationProperty::Property");
    qRegisterMetaType<LingmoSearch::ApplicationInfoMap>("ApplicationInfoMap");
    qRegisterMetaType<LingmoSearch::ApplicationPropertyMap>("ApplicationPropertyMap");
    qDBusRegisterMetaType<LingmoSearch::ApplicationProperty::Property>();

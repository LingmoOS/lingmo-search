...
class LingmoSearch::SearchResultPropertyInfoPrivate
{
public:
...
SearchResultPropertyInfo &LingmoSearch::SearchResultPropertyInfo::operator=(const SearchResultPropertyInfo &rhs)
{
    *d = *rhs.d;
    return *this;
}
...
SearchProperty::SearchResultProperty LingmoSearch::SearchResultPropertyInfo::property() const
{
    return d->m_property;
}

...
private:
    explicit DateFormat(QObject *parent = nullptr) : QObject(parent)
    {
        ...
        qDebug() << "connect sdk date signal" << QDBusConnection::sessionBus().connect("com.lingmo.kysdk.DateServer",
                                                                                       "/com/lingmo/kysdk/Date",
...
void LingmoSearch::FileSearchPlugin::KeywordSearch(QString keyword, DataQueue<ResultInfo> *searchResult)
{
...
void LingmoSearch::DirSearchPlugin::KeywordSearch(QString keyword, DataQueue<ResultInfo> *searchResult)
{
...
void LingmoSearch::FileContentSearchPlugin::KeywordSearch(QString keyword, DataQueue<ResultInfo> *searchResult)
{

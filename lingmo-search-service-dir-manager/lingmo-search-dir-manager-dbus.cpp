...
LingmoSearchDirManagerDbus::LingmoSearchDirManagerDbus(int &argc, char *argv[], const QString &applicationName)
    : QtSingleApplication (applicationName, argc, argv)
{
    ...
    if (!this->isRunning()) {
        ...
        qWarning() << "Lingmo search dir manager is running!";
    }
    //parse cmd
    qDebug()<<"parse cmd";
...
void LingmoSearchDirManagerDbus::parseCmd(QString msg, bool isPrimary)
{

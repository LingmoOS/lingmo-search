...
class LingmoSearchDirManagerDbus : public QtSingleApplication
{
    Q_OBJECT
public:
    LingmoSearchDirManagerDbus(int &argc, char *argv[], const QString &applicationName = "lingmo-search-service-dir-manager");
protected Q_SLOTS:

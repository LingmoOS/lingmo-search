...
LingmoSearchAppDataService::LingmoSearchAppDataService(int &argc, char *argv[], const QString &applicationName):
...
void LingmoSearchAppDataService::parseCmd(QString msg, bool isPrimary)
{
